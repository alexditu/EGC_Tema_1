...
#define WINDOW_X_MIN -800
#define WINDOW_Y_MIN -450
#define WINDOW_X_MAX 800
#define WINDOW_Y_MAX 450
...
public:
	...
	static void goToNextLevel (int level);
	static void makeEnemies (int *number);
